...
class BatchGenerate:
    ...
    def _load_params(self):
        self.params = toml.load(self.param_dir / 'ts_batch' / f'{self.batch_name}.toml')
    ...
    def run(self):
        ...
        for factor_info in factors:
            ...
            org_name = factor_info.get('org_name')
            ind_cate = factor_info.get('ind_cate')
            factor_list = factor_info.get('factor_list')
            org_dir = factor_info.get('org_dir')
            target_dir = factor_info.get('target_dir')
